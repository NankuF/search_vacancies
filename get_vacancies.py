...
def main():
    ...
    - График работы (выбрать что-то одно: удаленная работа; полный день; сменный график; гибкий график
    ...
    while True:
        ...
        while True:
            schedule = input('- График работы (выбрать что-то одно: удаленная работа; полный день; сменный график; гибкий график'
                             ' ЛИБО нажмите ENTER, чтобы выбрать все графики работы): ')
